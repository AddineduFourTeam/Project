    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
      ...
      /*  String requestURI = request.getRequestURI();
        ...
        if (requestURI.equals("/") || requestURI.startsWith("/login") || requestURI.startsWith("/join") || requestURI.startsWith("/idCheck")
                || requestURI.startsWith("/list") || requestURI.startsWith("/board") || requestURI.startsWith("/story") || requestURI.startsWith("/memInsert")
                || requestURI.startsWith("/forgotPass")|| requestURI.startsWith("/forgotPassCheck")|| requestURI.startsWith("/completePass")
                || requestURI.startsWith("/cancelComplete")|| requestURI.startsWith("/api/coordinates")) {
            return true;
        }/*else{
