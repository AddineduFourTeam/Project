...
public class StoryController {
    ...
    public List<Farm> storyLocal(@RequestParam(value="local") String local,Model model) {
        //String local_data = local+"%";
        List<Farm> localList = listService.localList(local);
        System.out.println("localList = " + localList);
        //model.addAttribute("localList", listService.localList(local));
        return "localList";
    }
}
